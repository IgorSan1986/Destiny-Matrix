				...
				<section class="form login-registration">
					<div class="login-registration__btn">
						<a href="http://localhost/login.php">
							<button id="login" data-form="form-login" aria-expanded="false" aria-controls="form-login" type="button">
								Log in
							</button>
						</a>
					</div>
					...
					<div class="login-registration__btn">
						<a href="http://localhost/registration.php">
							<button id="registration" data-form="form-registration" class="login-registration--active"
								aria-expanded="true" aria-controls="form-registration" type="button">
								Registration
							</button>
						</a>
					</div>

					<form id="form-registration" class="form-login-registration" action="">
						...
						<div class="form-login-registration__item2">
							...
							<input type="email" id="email-registration" name="email-registration" placeholder="Email*" />
						</div>

						<div class="form-login-registration__item3">
							<input type="text" id="password-registration" name="password-registration"
								placeholder="Create a Password*">
						</div>

						<div class="form-login-registration__item4">
							<button id="registration-btn" class="login-registration--active" type="submit">
								Register now
							</button>
						</div>
