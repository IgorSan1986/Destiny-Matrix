					...
					<form id="form-personal" class="grid-form__item3 personal" action="">
						<ul class="grid-list__container">
							...
							<li class="grid-list-item3">
								...
								<input id='date-of-birth' class="" type="text" id="date" name="date" placeholder="Date of Birth *" />
							</li>
					...
					<form id="form-compatibility" class="grid-form__item3 compatibility d-none " action="">
						<ul class="grid-list__container">
							<li class="grid-list-item1 compatibility">
								...
								<input type="text" id="date-partner1" name="date-partner1" placeholder="Date of Birth - Partner 1 *" />
							</li>
							<li class="grid-list-item3 compatibility">
								<label class="visually-hidden" for="date-partner1">Enter date of birth for partner 1</label>
								<input type="text" id="date-partner2" name="date-partner2" placeholder="Date of Birth - Partner 2 *" />
							</li>
				...
				<ul>
					...
					<li>
						...
						<p>
							...
							<strong>connection with your inner self</strong>, accessing inner wisdom, and nurturing
					...
					<li>
						<picture>
							<source type="image/webp" srcset="
									...
									" />
							<img src="resources/img/testimonials-1.jpg" srcset="
					...
					<li>
						<picture>
							<source type="image/webp" srcset="
									...
									" />
							<img src="./resources/img/testimonials-2.jpg" srcset="
					...
					<li>
						<picture>
							<source type="image/webp" srcset="
									...
									" />
							<img src="./resources/img/testimonials-3.jpg" srcset="
				...
				<ul>
					...
					<li class="discover-item2">
						<p>
							...
							light on
							<strong>your unique strengths and
								qualities</strong>. Gain a deeper understanding of yourself
