<header class="header">
	<div class="container d-block-md">
		<nav class="nav-bar">
			<button class="menu__btn" aria-expanded="false" aria-controls="menu__list" type="button">
			...
			<ul class="menu__list">
				...
				<li>
					<a href="http://localhost/profile.php">Buy</a>
				</li>
				<li>
					<a href="http://localhost/blog-page.php">Blog</a>
				</li>
